            ...
            <div id="carouselWrapper">
                <div class="carouselEach">
                    ...
                    <div class="projectIndex">
                        ...
                        <h1>
                            Nome do projeto que pode ser extremamente grande
                        </h1>
                        <div class="projectH2">
                        ...
                        <ul>
                            ...
                            <span class="icon icon2" id="iconResume"></span><b>Descrição</b>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam id feugiat augue. Vivamus id faucibus orci. Pellentesque volutpat nisi eu erat feugiat facilisis facilisis non nisi. Nam a scelerisque lacus. Quisque posuere gravida ante eget porta. Ut tincidunt vestibulum turpis ut congue. Nam dignissim dapibus velit venenatis placerat.</p>
                            </li>
                        </ul>
                    </div>
                    <div class="projectIndexInfo">
                        <div class='projectIndexCover'></div>
                        <p> Conhecer projeto</p>
                    </div>
                </div>
                <div class="carouselEach">
                    <div class="carouselCover"></div>
