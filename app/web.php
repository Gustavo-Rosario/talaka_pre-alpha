...
//Login
//curl -v -X POST "http://talaka-pre-alpha-gmastersupreme-1.c9users.io/exec/client/auth" -H "Content-Type: application/json"  -d '{"login":"eren@gmail.com","pwd":"teste"}'
